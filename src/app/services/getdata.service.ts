...
export class GetdataService {
  data = [
    ...
    },
    {
      ...
      beschreibung:
        '<p>Projekt HYBEAM | Wie kann Mixed Reality (MR) die Zukunft der Fort- und Weiterbildung pr\u00e4gen? </p><p>Im Beitrag FutureTalk erlebst du, wie digitale und physische Lernr\u00e4ume miteinander verschmelzen. Mit einer MR-Brille kannst du in Echtzeit mit einer Person an einem anderen Standort interagieren - als w\u00fcrdet ihr euch im selben Raum befinden. Durch r\u00e4umliches Audio, virtuelle Avatare und geteilte digitale Inhalte entsteht ein immersives Gruppengespr\u00e4ch, das \u00fcber klassische Videokonferenzen hinausgeht.</p>',
      beginn: '2025-06-20T17:00:00',
      ende: '2025-06-20T20:00:00',
      ort: 'Campus Augustusplatz der Universit\u00e4t Leipzig',
      ort_id: '5es8kblwr8mmtceh',
      adresse:
        'Augustusplatz 10, 04109 Leipzig / Foyer der Wirtschaftswissenschaftlichen Fakult\u00e4t, Eingang \u00fcber Innenhof oder Grimmaische Stra\u00dfe 12',
      einrichtung:
  ...
  constructor() {
    ...
    this.data.forEach((item) => {
      ...
      item.beginn = `${begin.getHours()}:${
        begin.getMinutes() < 10 ? '0' + begin.getMinutes() : begin.getMinutes()
      }`;
